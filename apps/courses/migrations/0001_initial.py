    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_banner', models.BooleanField(default=False, verbose_name='\u8bfe\u7a0b\u540d')),
                ...
                ('category', models.CharField(default='\u540e\u7aef\u5f00\u53d1', max_length=20, verbose_name='\u540e\u7aef\u5f00\u53d1')),
                ('add_time', models.DateField(default=datetime.datetime.now, verbose_name='\u6dfb\u52a0\u65f6\u95f4')),
                ('youneed_know', models.CharField(default='', max_length=500, verbose_name='\u8bfe\u7a0b\u987b\u77e5')),
                ('teacher_tell', models.CharField(default='', max_length=500, verbose_name='\u8001\u5e08\u544a\u77e5')),
            ],
        ),
        migrations.CreateModel(
            name='CourseResouce',
